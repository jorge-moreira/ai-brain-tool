...
import { getStatus } from '../core/commands/status.js'
import { runSetup } from '../core/commands/setup.js'
import { update } from '../core/commands/update.js'
import { list } from '../core/commands/list.js'
import { getBrainPath, readBrainConfig, writeBrainConfig, addBrain, ensureConfigDir, configPath, isBrainIdAvailable } from '../core/config.js'
import { createBrainFolder, writeBrainConfig as scaffoldWriteBrainConfig } from '../core/scaffold.js'
import { createVenv } from '../core/graphify.js'
import { detectAll, configureSelected, type DetectedPlatform } from '../core/platforms/index.js'
import { initRepo, writeGitignore } from '../core/git.js'
