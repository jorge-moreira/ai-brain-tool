...
describe('config', () => {
  ...
  describe('toggleSync', () => {
    it('should set gitSync to true', async () => {
      const brainPath = join(tmpHome, 'brain')
      mkdirSync(brainPath, { recursive: true })
    ...
    it('should set gitSync to false', async () => {
      const brainPath = join(tmpHome, 'brain')
      mkdirSync(brainPath, { recursive: true })
      toggleSync(brainPath, true)
  ...
  describe('toggleSyncById', () => {
    it('should resolve brain by id and toggle sync', async () => {
      const brainPath = join(tmpHome, 'work')
      mkdirSync(brainPath, { recursive: true })
      addBrain('work', brainPath)
      toggleSyncById('work', true)
      const config = readBrainConfig(brainPath)
      expect(config.gitSync).toBe(true)
    })
