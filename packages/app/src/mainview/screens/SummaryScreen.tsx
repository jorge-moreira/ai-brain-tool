      ...
      <div className="card-content">
        ...
        <ul className="summary-list">
          <li className="summary-item">
            <Check className="w-5 h-5 text-secondary summary-check" />
            <div className="summary-content">
              <div className="summary-title">
                ...
                >
                  <HelpCircle className="w-4 h-4 text-muted-foreground ml-2 cursor-help inline" />
                  {showExtrasTooltip && (
          ...
          <li className="summary-item">
            {selectedTools.length > 0 ? (
              ...
              <XCircle className="w-5 h-5 text-muted-foreground summary-skip" />
            )}
            <div className="summary-content">
              <div className="summary-title">
